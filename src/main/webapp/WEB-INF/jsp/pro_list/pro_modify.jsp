                ...
                <div class="layui-tab-item layui-show">
                   ...
                   <!-- <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="Original_password" autocomplete="off" placeholder="控制在80个汉字，160个字符以内"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="project_name" autocomplete="off" placeholder="控制在80个汉字，160个字符以内"
                                   class="layui-input" value="">
                        </div>
                    </div>
...
<script>
    layui.use(['laydate','element','layer','form'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            var Original_password=$("input[name='Original_password']:checked").val();

            if(project_name==""){
                layer.msg('原密码不能为空',{icon:5,time:2000});return false;
            }
            if(Original_password==""){
                layer.msg('新密码不能为空',{icon:5,time:2000});return false;
            }
