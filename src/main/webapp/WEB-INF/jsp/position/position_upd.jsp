        ...
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
            ...
            <div class="layui-tab-content" >
                <div class="layui-tab-item layui-show">
                    <input type="hidden" name="id" value="${PositionMapper.id}">
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <span class='x-red'>*</span>职能名称
                        </label>
                        <div class="layui-input-block">
                            <input type="text" name="position_name" autocomplete="off" placeholder="空制在80个汉字，160个字符以内"
                                   class="layui-input" value="${PositionMapper.position_name}">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
    ...
    layui.use(['laydate','element','layer','form'], function(){
        ...
        form.on('submit(upd)', function(data){
            ...
            if(position_name===""||position_name==null){
                layer.msg('职能名称不允许为空',{icon:5,time:2000});return false;
            }
            var data=data.field;
            $.ajax({
                type:"post",
                url:"/position/updPosition",
                data:data,
                dataType:"json",
