...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../statics/lib/bootstrap/css/bootstrap.css" media="all">
        <link rel="stylesheet" href="../../statics/lib/bootstrap/js/bootstrap.min.js" media="all">
    </head>
    <body>
    <style type="text/css">
	...
	.layui-table{ font-family: "Microsoft YaHei","Helvetica Neue";}
        ...
        <div class="x-body">
            <blockquote class="layui-elem-quote">
                欢迎使用文化有限公司管理系统！<!--<span class="f-14">v1.0</span>--> <!--&nbsp;&nbsp;登录次数：520-->
            </blockquote>
<div class="row">
            ...
            <fieldset class="layui-elem-field layui-field-title site-title">
              <legend><a name="default">信息</a></legend>
            </fieldset>
