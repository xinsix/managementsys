...
<div class="x-body">
        ...
        <div class="layui-form-pane" style="margin-top: 15px;">
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    <input type="text" name="department_name"  placeholder="部门名称" autocomplete="off" class="layui-input">
                </div>
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="activity_add('添加','/page/department_add','1000','600')">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td class="td-manage">
                <a title="编辑" href="javascript:;" onclick="activity_edit('编辑','/page/updDepartment','${Department.id}','1000','600')"
                   class="ml-5" style="text-decoration:none">
                    <i class="layui-icon">&#xe642;</i>
                </a>
                <a title="删除" href="javascript:;" onclick="Department_del(${Department.id})"
