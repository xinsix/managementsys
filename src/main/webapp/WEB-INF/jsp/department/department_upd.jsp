                ...
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label" style="width: 115px;">
                            <span class='x-red'>*</span>修改部门名称
                        </label>
                        <div class="layui-inputb-lock">
                            <textarea name="department_name" style="height: 300px" autocomplete="off" placeholder="请输入部门名称"
                                      class="layui-input" required="" value="">${department.department_name}</textarea>
                        </div>
                    </div>
...
<script>
    ...
    layui.use(['laydate','element','layer','form'], function(){
        ...
        form.on('submit(upd)', function(data){
            var department_name=$("textarea[name='department_name']").val();
            if(department_name===""||department_name==null){
                layer.msg('部门名称不允许为空',{icon:5,time:2000});return false;
            }
            var data=data.field;
            $.ajax({
                type:"post",
